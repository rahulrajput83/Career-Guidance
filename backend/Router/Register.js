    ...
    .then((value) => {
        const message = {
            ...
            from: {
                ...
                email: 'ramrajput200021@gmail.com'
            },
            subject: 'Verify Career Guidance Account',
            text: 'Hello from Career Guidance',
            html: `<!DOCTYPE html>
            <html>
            <head>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                          <a href="https://career-guidance.vercel.app/" target="_blank" style="display: inline-block;">
                            Career Guidance
                          </a>
                        </td>
                      </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account with <a href="https://career-guidance.vercel.app/">Career Guidance</a>, you can safely delete this email.</p>
                        </td>
                      </tr>
                      <!-- end copy -->
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                          <p style="margin: 0;">Cheers,<br>Career Guidance</p>
                        </td>
                      </tr>
                      <!-- end copy -->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                          <p style="margin: 0;">You received this email because once has created an account with email address ${value.emailID}. If you didn't created an account, you can safely delete this email.</p>
                        </td>
                      </tr>
                      <!-- end permission -->
                    </table>
