...
function DeletAccount() {
  ...
  return (
    <div className='w-100 shadow p-4 mt-5 mt-md-0 text-center shadow-5 rounded-3 d-flex flex-column'>
      ...
      <span>If you delete your account, all data associated with your account will be deleted forever and all questions/answers that you have posted will remains posted. Once deleted, this process can't be reverse.</span>
